                        ...
                        <tr class="group hover:bg-slate-800/40 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-white group-hover:text-indigo-300 transition-colors">{{ $product->name }}</div>
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm font-mono font-medium text-emerald-400">₱{{ number_format($product->price, 2) }}</span>
                            </td>
                            <td class="hidden md:table-cell px-6 py-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold {{ $product->category ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'bg-slate-800 text-slate-500 border border-slate-700' }}">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('products.create') }}" class="mt-3 text-sm text-indigo-400 hover:text-indigo-300 font-semibold underline underline-offset-4 transition-colors">
